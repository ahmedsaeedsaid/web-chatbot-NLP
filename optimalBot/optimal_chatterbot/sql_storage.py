...
class SQLStorageAdapter(StorageAdapter):
    ...
    def get_statement_model(self):
        ...
        """
        from optimal_chatterbot.models import Statement
        return Statement
    ...
    def get_tag_model(self):
        ...
        """
        from optimal_chatterbot.models import Tag
        return Tag
    ...
    def create_many_customized(self, statements,client_id):
        """
        Creates multiple statement entries.
        """
        Statement = self.get_model('statement')
        ...
        for statement in statements:
            ...
            for tag_name in tag_data:
                ...
                statement_model_object.tags.append(tag)
            statement_model_object.client_id = client_id
            create_statements.append(statement_model_object)
    ...
    def create_database(self):
        ...
        """
        from optimal_chatterbot.models import Base

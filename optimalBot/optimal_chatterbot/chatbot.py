...
class chatBot(chatterbot.ChatBot):
    ...
    def get_response(self, statement=None, **kwargs):
        ...
        response, Story_ID ,children_questions = self.generate_response(input_statement, additional_response_selection_parameters)
    ...
    def generate_response(self, input_statement, additional_response_selection_parameters=None):
        ...
        for adapter in self.logic_adapters:
            if adapter.can_process(input_statement):
                ...
                output, Story_ID ,children_questions = adapter.process(input_statement, additional_response_selection_parameters)

...
<body>
                ...
                <div class="col-md-4">
                    <div class="profile-card text-center">
                        ...
                        <div class="profile-info">
                            ...
                            <h2 class="hvr-underline-from-center"><?= $this->session->userdata('assis_name') ?><span><?= $this->session->userdata('assis_job') ?></span></h2>
                            <div><?= $this->session->userdata('assis_brief') ?></div>
                            <?php if($this->session->userdata('assis_facebook') != ''){ ?>
                                <a href="<?= $this->session->userdata('assis_facebook') ?>"><i class="fa fa-facebook fa-2x"></i></a>
                            <?php } ?>
                            <?php if($this->session->userdata('assis_email') != ''){ ?>
                                <input value="<?= $this->session->userdata('assis_email') ?>" id="email" type="hidden">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= base_url() ?>support/main">
                <p id="geeks_word_p">SUPPORT</p>
            </a>
        </div>
        <!-- Top Menu Items -->
        <ul class="nav navbar-right top-nav">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> <?= $this->session->userdata('assis_username') ?> <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li>
                        <a href="<?= base_url() ?>support/logout"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#user-drop-down"><i class="fa fa-fw fa-arrows-v"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="user-drop-down" class="collapse">
                        <li>
                            <a href="<?php echo base_url() ?>Users/list">Users List</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#client-drop-down"><i class="fa fa-fw fa-arrows-v"></i> Clients <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="client-drop-down" class="collapse">
                        <li>
                            <a href="<?php echo base_url() ?>Clients/list">Clients List</a>
                        </li>
                    </ul>
                </li>
                <li>
